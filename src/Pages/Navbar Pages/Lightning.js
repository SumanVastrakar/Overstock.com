...
export default function Lighting() {
  return (
    ...
    <div className='InsideBoxOfNewNavbarHavingText'>
     <p className='headingOfallNavbar'>Ceiling Lights</p>
  ...
  <div className='InsideBoxOfNewNavbarHavingText'>
  <p className='headingOfallNavbar'>Wall Lightning</p>
  ...
  <div className='InsideBoxOfNewNavbarHavingText'>
  <p className='headingOfallNavbar'>Lamps & Lamp Shades</p>
  ...
  <div className='InsideBoxOfNewNavbar'>
      <img className="InsideBoxOfNewNavbarImg" src="https://ak1.ostkcdn.com/images/products/is/images/direct/69d6ab9a69fc24a9f5adf1ccef4d0fcf833bf07e/Aged-Wood-Beaded-6-Light-Candle-Chandelier.jpg" alt="AllNew" />
      <p  className='my-4 headingOfallNavbar'>extra 15% Off</p>
      <p>Select Lightning*</p>
  </div>
