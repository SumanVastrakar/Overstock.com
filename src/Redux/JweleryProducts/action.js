...
export const fetchData = (payload) => (dispatch) => {
    ...
    axios.get("https://overstockbackendsuman.herokuapp.com/dataJewellery", {
        params : {
            ...payload
        }
    })
...
export const getSingleProduct = (id) => (dispatch) => {
    axios.get(`https://overstockbackendsuman.herokuapp.com/dataJewellery/${id}`).then(d => dispatch(getSingleProductSuccess(d.data)))
